    ...
    <div class="detail-order" v-show="isDetailShow">
        <div class="dialog">
            ...
            <div class="option-order">
                <button style="background-color:red" v-show="toShow(billDetail.state)" @click="updateState(2)">Huỷ đơn hàng</button>
                <button style="background-color:#23ae41" v-show="toShow(billDetail.state)" @click="updateState(1)">Xác nhận đơn hàng</button>
